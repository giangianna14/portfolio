  ...
  return (
    <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-20 lg:px-24 lg:py-0">
      ...
      <div className="lg:flex lg:justify-between lg:gap-4">
        {/* Left Sticky Panel */}
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:pt-24 lg:overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
          <LeftPanel />
        </header>
